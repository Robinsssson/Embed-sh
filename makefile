...
SOURCES = \
    $(SOURCES_DIR)/main.c \
    $(SOURCES_DIR)/sh/sh_map/sh_map.c \
    $(SOURCES_DIR)/sh/sh_func/echo.c \
    $(SOURCES_DIR)/sh/sh_func/export.c \
    $(SOURCES_DIR)/sh/sh.c \
    $(SOURCES_DIR)/string/sh_string.c \
    $(SOURCES_DIR)/sh/sh_utli/usart1.c \
    $(SOURCES_DIR)/sh/sh_val_map/sh_val_map.c \
...
# Libraries
LIBS = \
    -L/home/orangepi/Projects/stm32f103/sh_demo/lib/sds -lsds \
    -lc
...
# Remove binary files
.PHONY: clean flash compile_commands all
